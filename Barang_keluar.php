				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Stock Barang Keluar</h2>
								...
								<div class="card-body">
											...
											<div class="modal-content">
												...
												<div class="modal-body">
														...
														<div class="row">
															...
															<div class="col-sm-12">
																<div class="form-group">
																	...
																	<input name="penerima" type="text" class="form-control" placeholder="Masukkan Penerima..." required>
																</div>
															</div>
															<div class="col-sm-12">
																<div class="form-group">
                                                    ...
                                                    <div class="modal-footer no-bd">
                                                        <button type="submit" name="add_barang_keluar" class="btn btn-primary">Save</button>
									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
                                            ...
                                            <?php
                                                // $i = 1;
                                                $get_all_data = mysqli_query($conn, "select * from barang_keluar k, stock s where s.id_barang = k.id_barang ");
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
															<div class="form-button-action">
                                                                <button type="button" class="btn btn btn-link btn-primary" data-toggle="modal" data-target="#edit<?= $id_keluar;?>">
                                                                    <i class="fa fa-edit"></i>
                                                                </button>
                                                                <input type="hidden" name="id_keluar" value="<?= $id_keluark;?>">
                                                                <button type="button" data-toggle="modal" data-target="#delete<?= $id_keluar;?>" class="btn btn-link btn-danger">
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="post">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-12">
                                                                                <div class="form-group">
                                                                                    <label  class="fw-bold">Penerima</label>
                                                                                    <input id="addPosition" name="penerima" type="text" class="form-control" value="<?= $penerima;?>">
                                                                                </div>
                                                                            </div>
																			<div class="col-sm-12">
                                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="modal-footer no-bd">
                                                                        <button type="submit" name="update_barang_keluar" id="addRowButton" class="btn btn-primary">Save</button>
                                                                        <button type="button" class="btn btn-danger" data-dismiss="modal">Tutup</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="modal-footer no-bd">
                                                                        <button type="submit" name="hapus_barang_keluar" id="addRowButton" class="btn btn-primary">Hapus</button>

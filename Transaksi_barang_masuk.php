				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Transaksi Barang Masuk</h2>
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<table id="add-row" class="display table table-striped table-hover" >
                                            ...
                                            <?php
                                                $i = 1;
                                                $get_all_data = mysqli_query($conn, "select * from trans_barang_masuk m, stock s where s.id_barang = m.id_barang ");
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="modal-footer no-bd">
                                                                        <button type="submit" name="hapus_trans_masuk" id="addRowButton" class="btn btn-primary">Hapus</button>
